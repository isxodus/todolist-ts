...
export const todolistsApi = {
    ...
    getTasks(tdId: string) {
        return instance.get<TaskResponseType>(`todo-lists/${tdId}/tasks`)
            .then(response => response.data)
    },
    ...
    deleteTask(tdId: string, taskId: string) {
        return instance.delete<ResponseType>(`todo-lists/${tdId}/tasks/${taskId}`)
            .then(response => response.data)
    },
    updateTask(tdId: string, taskId: string, model: UpdateTaskType) {
        return instance.put<ResponseType>(`todo-lists/${tdId}/tasks/${taskId}`, model)
            .then(response => response.data)
    }
}